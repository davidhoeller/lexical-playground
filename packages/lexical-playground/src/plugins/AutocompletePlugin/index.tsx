...
import {
  ...
  KEY_ARROW_RIGHT_COMMAND, KEY_ESCAPE_COMMAND,
  KEY_TAB_COMMAND,
} from 'lexical'
  ...
  useEffect(() => {
    ...
    function handleUpdate() {
      editor.update(() => {
        ...
        $clearSuggestion() // TODO we should not do this if the user replaces the next character(s) of the autosuggest, instead locally & synchronously update the autosuggest string, to prevent flicker
    ...
    function $handleCancelKeyCommand(e: Event) {
      const l = lastMatch
      $clearSuggestion()
      lastMatch = l // that's a bit of a hack: if we restore lastMatch, he suggestion won't reappear until the match changes (e.g. user enters next char). // TODO possibly make a param in $clearSuggestion?
      e.preventDefault()
      return true
    }
